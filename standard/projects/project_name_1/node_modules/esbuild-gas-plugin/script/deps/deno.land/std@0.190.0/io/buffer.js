...
class Buffer {
    ...
    readSync(p) {
        ...
        const nread = (0, copy_js_1.copy)(__classPrivateFieldGet(this, _Buffer_buf, "f").subarray(__classPrivateFieldGet(this, _Buffer_off, "f")), p);
    ...
    writeSync(p) {
        ...
        return (0, copy_js_1.copy)(p, __classPrivateFieldGet(this, _Buffer_buf, "f"), m);
    }
...
_Buffer_buf = new WeakMap(), _Buffer_off = new WeakMap(), _Buffer_instances = new WeakSet(), _Buffer_tryGrowByReslice = function _Buffer_tryGrowByReslice(n) {
    ...
    (0, asserts_js_1.assert)(len <= __classPrivateFieldGet(this, _Buffer_buf, "f").buffer.byteLength);
